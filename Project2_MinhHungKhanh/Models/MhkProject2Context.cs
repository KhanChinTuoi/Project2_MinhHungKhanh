...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-E55B6HI\\MAYTINH1;Database=MHK_Project2;uid=sa;pwd=minh1234; MultipleActiveResultSets=True; TrustServerCertificate=True ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<MhkAddress>(entity =>
        {
            entity.HasKey(e => e.MhkAddressId).HasName("PK__mhkAddre__3BFE1226F8B5593B");
        ...
        {
            entity.HasKey(e => e.MhkCategoryId).HasName("PK__mhkCateg__BCC94E834414B857");
        ...
        {
            entity.HasKey(e => e.MhkOrderId).HasName("PK__mhkOrder__97B33A64C10E9C44");
        ...
        {
            entity.HasKey(e => e.MhkOrderDetailId).HasName("PK__mhkOrder__3B412F41554217AE");
        ...
        {
            entity.HasKey(e => e.MhkProductId).HasName("PK__mhkProdu__7C856397F89DCA29");
        ...
        {
            entity.HasKey(e => e.MhkUserId).HasName("PK__mhkUsers__FD4C613EFF8CB3E7");

            entity.ToTable("mhkUsers");

            entity.HasIndex(e => e.MhkEmail, "UQ__mhkUsers__46F6BE4B883A5285").IsUnique();
